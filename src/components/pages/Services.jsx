    ...
    <div>
      <section className="mt-22.5 pb-[35px]">
        <div className="services-hero flex flex-col xl:ps-[130px] xl:pt-[110px] lg:ps-[100px] justify-center gap-10 px-6 py-10 rounded-[20px] shadow-[0px_0px_6px_0px_#00000059]">
          <h1 className="lg:text-[48px] text-2xl font-bold">Our Services</h1>
      ...
      <section className="xl:ps-[123px]   xl:pr-[127px] lg:py-[75px] py-10 flex flex-col lg:gap-6">
        <div className="bg-[#FBFBFB] rounded-[20px]  rounded-[20px]">
          <div className="flex flex-col gap-6  lg:px-[42px]  py-6">
            <div
            ...
            >
              ...
              <h1 className="lg:text-[36px] text-2xl font-bold">Website</h1>
            </div>
                ...
                >
                  <div className="flex flex-col gap-[50px] mt-[34px]">
                    <p className="lg:text-[24px] text-xl font-medium">
                      A website demonstrates professionalism and builds trust —
                      it has been proven to increase revenue by making your
                      products and services accessible to anyone, anywhere.
                    </p>
            ...
            <AnimatePresence initial={false}>
              {isOpen === 1 && (
                ...
                >
                  <div className="flex flex-col gap-[50px] mt-[34px]">
                    <p className="lg:text-[24px] text-xl font-medium">
                      Digital products are the future of scalable business. They
                      let you create once and sell infinitely, reaching global
                      audiences without the cost of inventory or shipping. From
                      eBooks and online courses to templates and software,
                      digital products open new revenue streams for businesses
                      of all sizes.
                    </p>
                    <div className="flex flex-col lg:text-[24px] gap-[14.29px]">
                      <div className="flex items-center gap-[20.5px]">
            ...
            <AnimatePresence initial={false}>
              {isOpen === 2 && (
                ...
                >
                  <div className="flex flex-col gap-[50px] mt-[34px]">
                    <p className="lg:text-[24px] text-xl font-medium">
                      Digital marketing connects your brand with the right
                      audience at the right time. With a tailored strategy, you
                      can boost visibility, build trust, and drive consistent
                      growth through measurable conversions.
                    </p>
                    <div className="flex flex-col lg:text-[24px] gap-[14.29px]">
                      <div className="flex items-center gap-[20.5px]">
                        <img src="/images/services/Cube.png" alt="cube-icon" />
      ...
      <section className="pb-5.25">
        <div className="flex flex-col items-center gap-17.5 py-15 lg:px-15 px-5 shadow-[0_0_6px_0_rgba(0,0,0,0.35)] rounded-2xl">
          <div className="flex flex-col gap-8.75 items-center ">
            <h2 className="lg:text-[36px] text-xl font-semibold text-center">
