      ...
      <section className="mt-[90px]">
        <div className="flex flex-col gap-6">
          ...
          <h2 className="lg:text-[24px] font-medium text-xl">
            ...
            transparent way. Designed with clean UX/UI and powered by AI-driven
            job matching, it simplifies every stage of the freelancing
            process—making it faster and more efficient for both talent and
            companies.
          </h2>
        </div>
      ...
      <section className="mt-[90px]">
        <div className="flex flex-col gap-6 max-w-[1223px]">
          ...
          <h2 className="lg:text-[24px] tracking-[2%] text-justify font-medium text-xl  xl:h-[211px]">
            Traditional freelance platforms are often overcrowded, complex, and
            hard to navigate. Users face lengthy onboarding, irrelevant job
            matches, and unclear payment structures. Our objective with
